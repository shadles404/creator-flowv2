  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Account Overview</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-lg transition-colors">
          <h3 className="text-lg font-semibold mb-6 text-slate-900 dark:text-slate-100">Views Performance</h3>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={reachData}>
                ...
                <Tooltip 
                  contentStyle={{ backgroundColor: '#ffffff', color: '#1e293b', border: '1px solid #e2e8f0', borderRadius: '12px' }}
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-lg transition-colors">
          <h3 className="text-lg font-semibold mb-6 text-slate-900 dark:text-slate-100">Expense Flow (Quarterly)</h3>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
...
const StatCard: React.FC<StatCardProps> = ({ title, value, sub, icon: Icon, color }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-md transition-colors">
      ...
      <div className="text-xs text-slate-400 dark:text-slate-500 mt-2">{sub}</div>
    </div>
  );
};
